...
type ServiceSupervisor interface {
    RegisterServiceFunc(fn serviceFunc)
...
func (s *srvcSupervisor) serve(service *Service) {
...
func (s *srvcSupervisor) RegisterService(srv Service) {
    s.Lock()
    defer s.Unlock()
...
func (s *srvcSupervisor) RegisterServiceFunc(fn serviceFunc) {
...
func (s *srvcSupervisor) WaitForEvent(name string, eventC chan Event, cancelC chan struct{}) {
    s.Lock()
    defer s.Unlock()
