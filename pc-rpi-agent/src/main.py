...
class PocketDaemon(Daemon):
    def run(self):
        ...
        try:
            ...
            sys.stderr.write('port {} in use...'.format(POCKETCAST_RECV))
            pocsock.close()
            exit()
        ...
        while True:
            try:
                ...
                if boundness == 'unbound':
                    ...
                    sys.stdout.write('[UNBOUNDED] POCKET Discover sent waiting for reply...\n')
                    ...
                    sys.stdout.write('[BOUNDED] POCKET Checker sent waiting for reply...\n')
                            ...
                            if cmd[MASTER_BOUND_AGENT] == config.get(MASTER_SECTION, MASTER_BOUND_AGENT) and \
                               cmd[SLAVE_NODE_MACADDR] == config.get(SLAVE_SECTION, SLAVE_NODE_MACADDR):
                                ...
                                if cmd[MASTER_IP4_ADDRESS] != config.get(MASTER_SECTION, MASTER_IP4_ADDRESS):
                                    ...
                                    sys.stdout.write("MASTER IP ADDRESS HAS CHANGED. CHANGE INTERFACE FILE\n")
                ...
                # state #3
                    ...
                    if boundness == 'bounded':
                        ...
                        sys.stdout.write("WE NEED A MASTER!\n")
                        wait_timer = UNBOUNDED_TIMEOUT
...
if __name__ == "__main__":
    ...
    daemon = PocketDaemon('/var/run/pocketd.pid')
